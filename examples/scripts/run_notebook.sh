...
NOTEBOOK=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/code/scANTIPODE/examples/1.9.1.8.3_Relu-NoInterceptOnApprox-Longer-ResetDC-NotLeaky.ipynb
