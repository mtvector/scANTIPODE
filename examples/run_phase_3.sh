...
#SBATCH --array=1-2 # Create an array job for each line in notebooks.txt
...
python ~/Matthew/code/scANTIPODE/examples/run_phase_3.py /allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/data/taxtest/HvQvM/HvQvMall_cere_clean_nodoublets.h5ad $NOTEBOOK